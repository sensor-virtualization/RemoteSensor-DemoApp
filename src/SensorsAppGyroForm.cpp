...
SensorsAppGyroForm::SensorsAppGyroForm(void)
	: __sensorMgr()
{
...
bool
SensorsAppGyroForm::Initialize(void)
{
	int ScreenHeight;
...
result
SensorsAppGyroForm::OnInitializing(void)
{
...
SensorsAppGyroForm::CreateLabel(Rectangle& rect, Color textcolor, Color background)
{
	Tizen::Ui::Controls::Label* _pLabel;
...
result
SensorsAppGyroForm::OnTerminating(void)
{
	StopSensor();
	return E_SUCCESS;
}
...
void
SensorsAppGyroForm::OnFormBackRequested(Tizen::Ui::Controls::Form& source)
{
	SceneManager* pSceneManager = SceneManager::GetInstance();
	AppAssert(pSceneManager);
	AppAssert(pSceneManager->GoBackward(BackwardSceneTransition(MainScene)) == E_SUCCESS);
...
void
SensorsAppGyroForm::OnSceneActivatedN(const Tizen::Ui::Scenes::SceneId& previousSceneId,
...
void
SensorsAppGyroForm::OnSceneDeactivated(const Tizen::Ui::Scenes::SceneId& currentSceneId,
...
result
SensorsAppGyroForm::OnDraw(void)
{
...
void
SensorsAppGyroForm::OnDataReceived(SensorType sensorType, SensorData& sensorData, result r)
{
...
void
SensorsAppGyroForm::StartSensor(void)
{
	long interval = 0L;
...
void
SensorsAppGyroForm::StopSensor(void)
{
