...
#ifndef _SENSOR_APP_GYRO_Form_H_
#define _SENSOR_APP_GYRO_Form_H_
...
{
public:
		SensorsAppGyroForm(void);
	virtual ~SensorsAppGyroForm(void);
...
#endif /* _SENSOR_APP_GYRO_Form_H_ */
