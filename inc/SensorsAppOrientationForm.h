...
#ifndef SENSORSAPPORIENTATIONForm_H_
#define SENSORSAPPORIENTATIONForm_H_
...
class SensorsAppOrientationForm
...
{
public:
		SensorsAppOrientationForm(void);
	virtual ~SensorsAppOrientationForm(void);
...
#endif /* SENSORSAPPORIENTATIONForm_H_ */
