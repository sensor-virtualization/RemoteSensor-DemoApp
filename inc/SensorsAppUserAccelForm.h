...
#ifndef SENSORSAPPUSERACCELForm_H_
#define SENSORSAPPUSERACCELForm_H_
...
{
public:
		SensorsAppUserAccelForm(void);
	virtual ~SensorsAppUserAccelForm(void);
