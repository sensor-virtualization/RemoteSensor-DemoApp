...
#ifndef SENSORSAPPLIGHTForm_H_
#define SENSORSAPPLIGHTForm_H_
...
{
public:
		SensorsAppLightForm(void);
	virtual ~SensorsAppLightForm(void);
...
#endif /* SENSORSAPPPROXIMITYForm_H_ */
