...
#ifndef _SENSOR_APP_MAGNETIC_Form_H_
#define _SENSOR_APP_MAGNETIC_Form_H_
...
{
public:
		SensorsAppMagneticForm(void);
	virtual ~SensorsAppMagneticForm(void);
...
private:
	...
	Tizen::Ui::Controls::Label* __pLabelXYZ;
...
#endif /* _SENSOR_APP_MAGNETIC_Form_H_ */
