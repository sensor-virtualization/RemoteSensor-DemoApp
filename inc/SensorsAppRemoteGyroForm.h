...
#ifndef SENSORSAPPREMOTEGYROForm_H_
#define SENSORSAPPREMOTEGYROForm_H_
...
class SensorsAppRemoteGyroForm
...
{
public:
		SensorsAppRemoteGyroForm(void);
	virtual ~SensorsAppRemoteGyroForm(void);
